...
c_rc_stability_error BS_AH_integrated_error={0};
c_rc_stability_error BS_AH_last_error={0};
...
arm_matrix_instance_f32 c_rc_BS_AH_coriolis_matrix(pv_msg_datapr_attitude attitude);
void c_rc_BS_AH_integrate_error(c_rc_stability_error current_error, float sample_time);
...
float c_rc_BS_AH_altitude_controller_step(float altitude, float altitude_reference, float rateOfClimb, float rateOfClimb_reference, pv_msg_datapr_attitude attitude)
{
	float Zeta3=0;
 ...
 */
pv_msg_io_actuation c_rc_BS_AH_controller(pv_msg_datapr_attitude attitude,
